    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-base font-medium text-gray-900">
          Marketplace Health {isDemo && "(demo)"}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-3xl font-medium text-gray-900">
              {data?.creatorCustomerRatio || "1:3.5"}
            </p>
          </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <p className="text-3xl font-medium text-gray-900">
              {data?.matchRate !== undefined ? `${data.matchRate}%` : "78.5%"}
            </p>
          </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            ...
            <p className="text-3xl font-medium text-gray-900">
              {data?.avgProjectValue !== undefined ? `€${data.avgProjectValue.toLocaleString()}` : "€676"}
            </p>
          </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            ...
            <p className="text-3xl font-medium text-gray-900">
              {data?.completionRate !== undefined ? `${data.completionRate}%` : "94.2%"}
            </p>
          </div>
        </div>
      </CardContent>
